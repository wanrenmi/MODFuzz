...
### 2.1 Run the cfg_construct_store.py script
This step will save the experimental results (CFG and symbol table) in pickle form.
### 2.2 Run the vulnerability_score.py script
...
### 2.3 Run function write_result_to_afl() in gadgets.py
